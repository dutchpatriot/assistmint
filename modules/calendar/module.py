...
from core.audio.tts import speak, get_language
from core.audio.stt import whisper_speech_to_text
from core.logger import cmd
...
class CalendarModule(BaseModule):
    ...
    def _handle_add_oneshot(self, max_retries: int, lang: str, initial_text: str = None) -> ModuleResult:
        ...
        """
        from calendar_manager import add_event_to_calendar_extended, parse_time, parse_date
    ...
    def _handle_add_stepbystep(self, max_retries: int) -> ModuleResult:
        ...
        from calendar_manager import add_event_to_calendar, parse_time, parse_date
        from datetime import timedelta
    ...
    def _handle_check(self) -> ModuleResult:
        ...
        from calendar_manager import check_calendar, parse_date
    ...
    def _handle_clear(self) -> ModuleResult:
        ...
        from calendar_manager import clear_calendar, parse_date
